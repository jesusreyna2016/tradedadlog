...
## Account baselines (as of 3 sep 2026, interactive live check)
- 785 followers (was 773 on 1 sep, +12 in 2 days). Posts counter reads 708 (was 649) — jump looks too large for organic new posts in 2 days, likely includes replies now counted in the tab; don't treat as 59 new original posts.
- Median recent post: low thousands of views. A "good" post clears ~5K-6K. Strong week-level outliers 12K-15K. **New: a viral-tier outlier just hit 15K+10K (see below), closing in on the all-time top 3.** All-time outliers 40K-84K.
